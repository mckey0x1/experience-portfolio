...
export const experienceData: Experience[] = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        tools: ["Mobile App", "QR Code Kiosk"],
        metrics: {
          adoptionRate: "65%",
        ...
        modules: {},
        team: [],
        documentLinks: ["https://example.com/checkin-process.pdf"]
      }
    ]
  },
  {
    ...
    projects: [
      {
        ...
        tools: ["POS Tracker", "Dining Reservations Tool"],
        metrics: {
    ...
    projects: [
      {
        ...
        overview:
          "Revamped spa booking to allow mobile reservations and preferences.",
        tools: ["SpaSoft", "Customer Portal"],
        metrics: null,
        initiatives: [],
        guestFeedback: [5, 4, 5],
        modules: {
          planning: {
            ...
            tags: ["ux_mockup", "workflow_mapping"]
          }
        },
        team: [],
